...
const fhss_config_t domains[] = {
    {"W750",  FREQ_HZ_TO_REG_VAL(750375000), FREQ_HZ_TO_REG_VAL(751950000), 4, 751000000},
    ...
    {"W990",  FREQ_HZ_TO_REG_VAL(990375000), FREQ_HZ_TO_REG_VAL(991950000), 4, 991000000},
    {"W1000",  FREQ_HZ_TO_REG_VAL(1000375000), FREQ_HZ_TO_REG_VAL(1001950000), 4, 1001000000},
    {"W1010",  FREQ_HZ_TO_REG_VAL(1010375000), FREQ_HZ_TO_REG_VAL(1011950000), 4, 1011000000},
    {"W1018",  FREQ_HZ_TO_REG_VAL(1018375000), FREQ_HZ_TO_REG_VAL(1019950000), 4, 1019000000}
};

#if defined(RADIO_LR1121)
const fhss_config_t domainsDualBand[] = {
    {"ISM2G4", FREQ_HZ_TO_REG_VAL(2300400000), FREQ_HZ_TO_REG_VAL(2302400000), 8, 2301000000}
};
#endif
